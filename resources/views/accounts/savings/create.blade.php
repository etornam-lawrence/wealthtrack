...
<x-layout>
    ...
    <div class="max-w-2xl mx-auto p-8">
      ...
      <div class="max-w-2xl mx-auto bg-white dark:bg-gray-800 p-8 mt-10 rounded-lg shadow-md">
        <h2 class="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100">Open Savings New Account</h2>
  
        <form action="{{ route('accounts.savings.store') }}" method="POST" class="space-y-6">
            @csrf
            <div>
